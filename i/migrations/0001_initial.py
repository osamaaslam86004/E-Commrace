...
<<<<<<< HEAD
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        choices=[("POWER_ACCESSORIES", "power accessories")],
                        max_length=255,
                        unique=True,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "monitor_type",
                    models.CharField(default="HOME_OFFICE", max_length=255),
                ),
                ...
                (
                    "built_speakers",
                    models.CharField(blank=True, default="yes", max_length=255),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ...
                            (
                                "CONTROLLABLE_OUTLETS/DUAL_LOAD_BOOK",
                                "Controllable_Outlets/Dual Load Banks",
                            ),
                        ],
                        max_length=50,
                    ),
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="pdu_power_accessories",
                        to="i.poweraccessories",
                    ),
                ),
            ],
        ),
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ...
                            ("BRIEFCASE", "Briefcase"),
                            (
                                "MESSENGER_AND_SHOULDER_BAGS",
                                "Messenger and shoulder Bags",
                            ),
                            ("BAGPACKS", "Bagpacks"),
                            ("HARDSHELL", "Hardshell"),
                        ],
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE,
                related_name="comp_product_category",
                to="i.productcategory",
            ),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                (
                    "computerandtabletsbaseclass_ptr",
                    models.OneToOneField(
                        auto_created=True,
                        on_delete=django.db.models.deletion.CASCADE,
                        parent_link=True,
                        primary_key=True,
                        serialize=False,
                        to="i.computerandtabletsbaseclass",
                    ),
                ),
                (
                    "computer_and_tablets_category",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="tablets_comp_tab",
                        to="i.computerandtablets",
                    ),
                ),
            ],
...
=======
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quantity_available', models.PositiveIntegerField(default=15)),
                ('restock_threshold', models.PositiveIntegerField(default=9)),
                ('Computer_SubCategory', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Monitors_Computer_Subcategory', to='i.computersubcategory')),
            ],
        ),
        migrations.CreateModel(
            name='ProductCategory',
        ...
        migrations.AddField(
            model_name='monitors',
            name='Product_Category',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Monitors_Product_Category', to='i.productcategory'),
        ),
        migrations.AddField(
            model_name='monitors',
            name='special_features',
        ...
        migrations.AddField(
            model_name='monitors',
            name='user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='monitor_user', to=settings.AUTH_USER_MODEL),
        ),
        migrations.CreateModel(
            name='MessengerAndShoulderBag',
            fields=[
