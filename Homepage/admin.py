...
class UserProfileAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        (None, {"fields": ("full_name", "age", "gender", "phone_number")}),
...
class CustomerAdmin(admin.ModelAdmin):
    ...
    fieldsets = ((None, {"fields": ("shipping_address", "wishlist")}),)
...
class CustomerServiceProfileAdmin(admin.ModelAdmin):
    ...
    ordering = ["department"]
    fieldsets = ((None, {"fields": ("department", "bio", "experience_years")}),)
